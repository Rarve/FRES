    ...
    public class GHBTransformer
    {
        ...
        private void GetDetails(SourceObj htmlObj)
        {
            ...
            try
            {
                ...
                re.Code = htmlObj.Data.GetStrBtw("ทรัพย์รอการขาย  รหัส", "<");
            ...
            {
                File.AppendAllText("D:/RE/T_GHB.log", DateTime.Now.ToString("yyyyMMdd HH:mm") + "," + htmlObj.Url + "," + ex.GetBaseException().Message + "\r\n");
            }
        }
    }
}
